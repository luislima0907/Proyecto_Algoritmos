...
class VistaVentas(Screen):
	...
	def crear_csv(self):
		...
		if self.ids.ventas_rv.data:
			...
			os.getcwd()
			"C:/Users/Dell Inspiron 5000/Desktop/Proyecto Final de Algoritmos/kivy_env/SistemaTransaccionalDeVentas/admin/admin.py"
			os.chdir("C:/Users/Dell Inspiron 5000/Desktop/Proyecto Final de Algoritmos/kivy_env/SistemaTransaccionalDeVentas/admin/ventas_csv")
			print("Estos son todos los archivos de las ventas que se han generado, el ultimo agregado es el que se ha creado recientemente con la fecha de hoy")
			print(os.listdir())
			print("Si quieres mandar un archivo de alguna venta debes hacer lo siguiente:\n1. Copia el nombre del archivo que tu quieras mandar, cada nombre te lo brindamos en la lista de archivos.\n2. Luego dirigete al archivo llamado 'envio.py' y sigue las instrucciones que te brindamos en ese lugar")
			print("Un archivo puede ser: '26-10-23.csv' tiene como nombre la fecha en la que se realizo la venta y termina con le extensión '.csv' ")
		else:
